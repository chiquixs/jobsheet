public class SmartFridge extends Kulkas implements Audible{
    ...
    public String getInfo(){
        String info = "";
        info += "Volume Smartfridge   : " + this.volume + "\n";
        info += "Jumlah Pintu         : " + this.getJumlahPintu() + "\n";
        info += "Harga Smartfridge    : " + this.getHarga() + "\n";
        info += "Warna Smartfridge    : " + this.getWarna() + "\n";
        info += "Merk Smartfridge     : " + this.getMerk();
